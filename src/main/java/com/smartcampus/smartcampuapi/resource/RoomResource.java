...
public class RoomResource {
    ...
    public Response assignSensorToRoom(@PathParam("roomId") String roomId,
        ...
        System.out.println("Assigning sensor " + sensorId + " to room " + roomId);

        return Response.ok("Sensor assigned to room").build();
    }

    //Get sensors of a room
    @GET
    @Path("/{roomId}/sensors")
    public Response getRoomSensors(@PathParam("roomId") String roomId) {
